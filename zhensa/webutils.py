...
exception_classname_to_text = {
    ...
    'zhensa.exceptions.ZhensaEngineCaptchaException': gettext("CAPTCHA"),
    'zhensa.exceptions.ZhensaEngineTooManyRequestsException': gettext("too many requests"),
    'zhensa.exceptions.ZhensaEngineAccessDeniedException': gettext("access denied"),
    'zhensa.exceptions.ZhensaEngineAPIException': gettext("server API error"),
    'zhensa.exceptions.ZhensaEngineXPathException': parsing_error_text,
