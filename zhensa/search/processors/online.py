...
class OnlineProcessor(EngineProcessor):
    ...
    def initialize(self):
        ...
        zhensa.network.set_timeout_for_thread(self.engine.timeout, start_time=default_timer())
        # reset the HTTP total time
        zhensa.network.reset_time_for_thread()
        # set the network
        zhensa.network.set_context_network_name(self.engine_name)
        super().initialize()
    ...
    def search(self, query, params, result_container, start_time, timeout_limit):
        ...
        try:
            ...
            self.logger.error("SSLError {}, verify={}".format(e, zhensa.network.get_network(self.engine_name).verify))
